...
kernelFile="${BINARIES_DIR}/zImage"
mbrFile="${BINARIES_DIR}/boot-part/grub/grub.img"
...
dd if=/dev/zero of=$ImageFile bs=100M count=1
...
cp ${BINARIES_DIR}/zImage $ImageMountDir/sys/
cp ${BINARIES_DIR}/boot-part/grub/grub.cfg $ImageMountDir/sys/
